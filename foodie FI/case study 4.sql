...
Customer 1: Started with Plan 0 on August 1, 2020. Upgraded to Plan 1 on August 8, 2020.

Customer 2: Began with Plan 0 on September 20, 2020. Subsequently upgraded to Plan 3 on September 27, 2020.

Customer 11: Initiated with Plan 0 on November 19, 2020. Later upgraded to Plan 4 on November 26, 2020.

Customer 13: Onboarded with Plan 0 on December 15, 2020. Progressed to Plan 1 on December 22, 2020, and then to Plan 2 on March 29, 2021.

Customer 15: Started with Plan 0 on March 17, 2020. Subsequently upgraded to Plan 2 on March 24, 2020, and then to Plan 4 on April 29, 2020.

Customer 16: Onboarded with Plan 0 on May 31, 2020. Progressed to Plan 1 on June 7, 2020, and then to Plan 3 on October 21, 2020.

Customer 18: Initiated with Plan 0 on July 6, 2020. Upgraded to Plan 2 on July 13, 2020.

Customer 19: Started with Plan 0 on June 22, 2020. Progressed to Plan 2 on June 29, 2020, and then to Plan 3 on August 29, 2020.
...
2. What is the monthly distribution of trial plan start_date values for our dataset - use the start of the month as the group by value 
  SELECT
    ...
    COUNT(DISTINCT customer_id) AS trial_starts_count
FROM subscriptions
WHERE plan_id = 0 
...
8. Can you further breakdown this average value into 30 day periods (i.e. 0-30 days, 31-60 days etc) 
WITH trial_plan AS (
    SELECT customer_id, 
...
WHERE s1.plan_id = '0' AND s2.plan_id = '3';
 ...
 11. What is the customer count and percentage breakdown of all 5 plan_name values at 2020-12-31? 
